...
Secondly, you can join our [crowd source data labeling project](http://synopsis.video/crowdsource)- suggest new data sources, more diverse concepts, and help label existing and new data to make Synopsis better, less biased, and learn more, and be more useful to everyone.
